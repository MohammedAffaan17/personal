...
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">Hello, <mark><?php echo e(Auth::user()->name); ?></mark>.</div>
            <div class="card-body">
    ...
    <table class="table table-bordered table-hover mt-3" id="datatable">
        ...
        <tbody id="task-list">
            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-task-id="<?php echo e($task->id); ?>" data-task-status="<?php echo e($task->status); ?>">
                    <th class="text-center" scope="row"><?php echo e($loop->iteration); ?></th>
                    <td class="text-center"><?php echo e($task->task); ?></td>
...
<?php echo $__env->make('auth.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\banao_technologies_assignment 2\resources\views/auth/dashboard.blade.php ENDPATH**/ ?>