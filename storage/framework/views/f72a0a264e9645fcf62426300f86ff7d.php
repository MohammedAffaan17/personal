            ...
            <?php if(Route::has('login')): ?>
                <div>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-success">Home</a>
                    <?php else: ?>
...
</html><?php /**PATH E:\laravel-custom-user-registration-login-master\resources\views/welcome.blade.php ENDPATH**/ ?>